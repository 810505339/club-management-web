 ...
 * @LastEditTime: 2023-10-03 10:42:36
 * @LastEditors: yxx
 * @Description: 
		...
		<div class="layout-padding-auto layout-padding-view">
			<el-row v-show="showSearch">
				<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList">
					...
					<el-form-item :label="$t('order.pay')" prop="role">
						<el-select v-model="state.queryForm.role" multiple :placeholder="$t('common.select') + $t('order.pay')">
					...
					<el-form-item :label="$t('order.type')" prop="lockFlag">
						<el-select v-model="state.queryForm.lockFlag" :placeholder="$t('common.select') + $t('order.type')">
							<el-option v-for="item in lock_flag" :key="item.id" :label="item.label" :value="item.value" clearable>
							</el-option>
						</el-select>
					</el-form-item>
