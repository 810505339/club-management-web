	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			...
			<el-table stripe :data="state.dataList" style="width: 100%" v-loading="state.loading" border
				...
				<el-table-column :label="t('sysuser.lockFlag')" prop="auditState" show-overflow-tooltip>
					<template #default="scope">
						<el-tag class="ml-2" v-if="scope.row.auditState"
							:type="scope.row.auditState == 'PASS' ? 'success' : 'danger'">{{
								$t('common.' + scope.row.auditState) }}
						</el-tag>
					</template>
				</el-table-column>
