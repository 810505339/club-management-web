 ...
 * @LastEditTime: 2023-09-28 00:04:36
 * @LastEditors: yxx
 * @Description: 
 * @FilePath: \club-management-web\src\views\finance\refund-list\index.vue
-->
<template>
		...
		<div class="layout-padding-auto layout-padding-view">
			<el-row class="ml10" v-show="showSearch">
				<el-form :inline="true" :model="state.queryForm" ref="queryRef">
					...
					<el-form-item :label="t('refund.type')" prop="jobStatus">
						<el-select :placeholder="t('common.select')" clearable v-model="state.queryForm.jobStatus">
			...
			<el-table :data="state.dataList" style="width: 100%" v-loading="state.loading" border
				...
				<el-table-column :label="t('refund.userName')" prop="jobGroup" show-overflow-tooltip />
				<el-table-column :label="t('refund.userPhone')" prop="jobGroup" show-overflow-tooltip />
				<el-table-column :label="t('refund.amount')" prop="jobGroup" show-overflow-tooltip />
				<el-table-column :label="t('refund.reason')" prop="jobGroup" show-overflow-tooltip />
				<el-table-column :label="t('refund.person')" prop="jobGroup" show-overflow-tooltip />
				<el-table-column :label="t('refund.status')" prop="jobStatus" show-overflow-tooltip>
				...
				<el-table-column :label="$t('common.action')" fixed="right" width="80">
					<template #default="scope">
						<el-button @click="handleJobLog(scope.row)" text type="primary">{{ $t('common.audit') }}</el-button>
...
const Audit = defineAsyncComponent(() => import('./audit.vue'));
...
const handleJobLog = (row) => {
	auditRef.value.openDialog(row.jobId);
};
